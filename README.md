...
Вы можете **2** раза запросить промежуточное ревью. Оно не повлияет на итоговую оценку. Ревью можно запросить не позднее, чем за 5 дней до дедлайна (мы укажем более точные дедлайны в формах на EDU, а также в чате курса).
...
1. Если вы хотите отправить работу на предварительное ревью, создайте новую ветку (review1, review2) от последнего коммита в dev, который вы хотите включить в ревью, откройте MR ⚠️**в свой репозиторий**⚠️ и отправьте ссылку в нужную форму на EDU. Мержить после ревью ничего не нужно! Вы так же можете указать, кому из проверяющих отдать работу на проверку. Если не указывать, то ваш МР проверит случайно выбранный проверяющий. 
